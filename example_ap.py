...
class HandlerBase(object):
    ...
    def htmltop( self ):
        ...
        self.response += f"<link rel=\"stylesheet\" href=\"{webapdirurl}example_ap.css\">\n"
        self.response += f"<script src=\"{webapdirurl}aes.js\"></script>\n"
        self.response += f"<script src=\"{webapdirurl}jsencrypt.min.js\"></script>\n"
        self.response += f"<script src=\"{webapdirurl}example_ap.js\" type=\"module\"></script>\n"
        self.response += f"<script src=\"{webapdirurl}example_ap_start.js\" type=\"module\"></script>\n"
        self.response += "</head>\n"
